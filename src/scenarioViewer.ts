					...
					<div class="sidebar">
						...
						<div id="intro-details" class="welcome">
							...
							<div class="content intro">
								...
								<div class="legend">
									<ul>
										<li>Class packages. Right-click to expand them to classes.</li>
										<li>Class. Right-click to see source (Ruby only)</li>
										<li>Dynamic dependencies</li>
										<li>Web services/endpoints. Right-click to expand.</li>
										<li>Databases that persist application data</li>
									</ul>
								</div>
							</div>
						</div>
